...
- 더비드(유료 분석 서비스) 비교(2026-09): 공사 제시가가 투찰 사정률 100.4~100.9% 수준. 고정 100.4/100.6/100.8 역검증 ×0.82/0.75/0.66 (60,534건) — 사정율보다 한참 높게 넣는 방식은 평균보다 못함. 추천 체크에 하한 미달 비율(`sb`) 설명.
